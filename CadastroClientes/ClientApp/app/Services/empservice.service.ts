...
export class EmployeeService {
    ...
    getEmployees(page, pageSize) {
        return this._http.get(this.myAppUrl + 'api/Employee/Index?page=' + page + '&pageSize=' + pageSize)
    ...
    getEmployeesByName(name, pageSize) {
        return this._http.get(this.myAppUrl + "api/Employee/GetEmployeesByName/" + name + '?pageSize=' + pageSize)
            .map((response: Response) => response.json())
            .catch(this.errorHandler)
    }
